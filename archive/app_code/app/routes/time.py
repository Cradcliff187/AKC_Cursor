...
def reports():
    ...
    try:
        ...
        user_response = supabase.from_("user_profiles") \
        ...
        return render_template('time/reports.html', time_entries=time_entries, projects=projects, users=user_response.data)
    except Exception as e:
